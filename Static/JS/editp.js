...
function agp(){
    ...
    switch (np){
        case '1':
            titulo1=document.getElementById("titulo").value;
            genero1=document.getElementById("generos").value;
            duracion1=document.getElementById("duracion").value;
            sinopsis1=document.getElementById("sinopsis").value;
            titulo_org1=document.getElementById("titulo_org").value;
            reparto1=document.getElementById("reparto").value;
            directo1=document.getElementById("director").value;
            console.log(titulo1);
            break;
        case '2':
